...
La spec `001` permite que el EDA avance en paralelo con un contrato común. La spec `002`, ya cerrada, convierte el método en un flujo reutilizable. La spec `003` permite desarrollar frontend con mocks sin esperar al modelo. La spec `000` permanece activa hasta cerrar privacidad, evidencia de usuario y ratificación de la evaluación; todavía no existe producto funcional.
