# EDA delivery evidence

## Purpose

Definir la evidencia reproducible y agregada necesaria para declarar cerrado el
EDA multiclase del proyecto CFPB, sin confundirlo con entrenamiento, inferencia
o resultados de producto.
