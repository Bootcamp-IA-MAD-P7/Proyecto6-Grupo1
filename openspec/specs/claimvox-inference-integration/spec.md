# ClaimVox local inference integration Specification

## Purpose

Define the controlled local path between ClaimVox and the prediction service,
including explicit configuration, contract validation, restricted CORS and
synthetic verification. It does not define a deployed product or automatic
routing.
