# CFPB training policy

## Purpose

Fijar las reglas reproducibles y seguras que deben aplicar los experimentos del baseline CFPB antes de entrenar un modelo multiclase.
...
Esta política MUST NOT entrenar modelos, modificar la interfaz, conectar backend, cambiar el target contractual ni verificar criterios de entrega. Debe preparar únicamente la configuración y las particiones necesarias para un cambio posterior de baseline.
...
- **THEN** se considera fuera de alcance de esta capacidad
