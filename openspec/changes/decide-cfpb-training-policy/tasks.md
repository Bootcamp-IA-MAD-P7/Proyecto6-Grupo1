...
- [ ] 4.4 [Jira/PR] Tras revisión humana, actualizar `PG-2` con el enlace de evidencia y el estado real de `T-006`; abrir una Pull Request hacia `dev` sin marcar `ESS-02`, `PG-2` ni `PG-3` como terminados sin toda su evidencia.
