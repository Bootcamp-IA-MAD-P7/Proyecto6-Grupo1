...
- [x] 5.3 [Miguel / coordinación] Preparar la Pull Request hacia `dev` con alcance, evidencia, límites y reversión; no fusionar ni archivar sin revisión humana. Evidencia: PR `#55` fusionada tras revisión humana; Jira `PG-12` quedó en `Listo` con enlace y límites explícitos.
