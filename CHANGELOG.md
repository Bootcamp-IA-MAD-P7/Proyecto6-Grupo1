...
- `ESS-04` pasa a `Verificado`: la React PWA consume inferencia local real con respuesta contractual y revisión humana. No acredita autenticación, persistencia, despliegue ni una operación productiva.
